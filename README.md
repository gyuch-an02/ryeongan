...
- 모든 진행은 `both`(둘 다 제출해야 진행) — 혼자서는 진행 불가 (PRD §7)
- 능력치(행동 7 / 감각·지식 5) · 아이템(개인 소유, 스탯과 독립, OR 조건 해금)
- 스탯으로 해금되는 선택지는 능력치명을 색으로 표시 (충족=초록 / 미충족=빨강, 잠금)
